...
public class GlobalExceptions {
    ...
    @ExceptionHandler(IllegalArgumentsExceptions.class)
    public ResponseEntity<StandardError> illegalArgumentsException (IllegalArgumentsExceptions e, HttpServletRequest request){
